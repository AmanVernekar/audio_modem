...
noise_std = 0.05
recording_without_noise = np.convolve(sent_signal, simulated_channel, 'full')[:-prefix_len+1]
...
# print(f"detect_index: {detected_index}")
...
recording_without_chirp = recording[sample_rate: ]
