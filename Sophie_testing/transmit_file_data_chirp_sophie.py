...
np.save(f"Sophie_testing/mod_seq_{symbol_count}symbols.npy", modulated_sequence)
...
np.save(f'Sophie_testing/{symbol_count}symbol_overall.npy', overall_sig)

# output_file = f'Sophie_testing/{symbol_count}symbol_audio_to_test_with.wav'
