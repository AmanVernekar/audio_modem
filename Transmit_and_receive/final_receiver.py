...
from transmit_file_data_5_known_ofdm_copy import encode_data, qpsk_modulator, create_ofdm_datachunks
...
if do_real_recording:
    ...
    _, recording = wav_to_numpy(filename)
...
known_datachunk_to_remove = known_datachunk[0][lower_bin : upper_bin + 1]/(1+1j)
...
def decode_one_symbol(symbol_index):
    ...
    complex_data = received_datachunk[lower_bin : upper_bin + 1]/known_datachunk_to_remove
