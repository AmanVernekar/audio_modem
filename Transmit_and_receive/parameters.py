...
symbol_len = datachunk_len + prefix_len # *2)     # total length of symbol                    #CHANGED HERE   
...
recording_data_len = 483840                 # number of samples of data (HOW IS THIS FOUND)  #   537600 OFDM suffix 483840 no suffix 
lower_bin = 85
upper_bin = 850
symbol_count = 105
